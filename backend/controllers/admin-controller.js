...
const adminLogin = async (req, res, next) => {
    ...
    const token = jwt.sign({id: existingAdmin._id}, process.env.SECRET_KEY, {expireIn: '7d'})
...
module.export = {addAdmin, adminLogin, getAdmins, getAdminByID}